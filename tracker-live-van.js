...
function style(){
 ...
 .nwtbVanShell{position:relative;transform-origin:50% 58%;filter:drop-shadow(0 3px 5px rgba(15,23,42,.32));will-change:transform}
 .nwtbVanShell.desktop{width:82px;height:54px}.nwtbVanShell.mobile{width:58px;height:40px}
 .nwtbVanBody{position:absolute;left:4px;top:9px;width:57px;height:32px;background:linear-gradient(180deg,#fff,#eef2f6);border:2px solid #17202a;border-radius:7px 5px 5px 7px;overflow:hidden}
 ...
 .nwtbVanCab{position:absolute;left:56px;top:16px;width:22px;height:25px;background:#fff;border:2.5px solid #17202a;border-left:0;border-radius:0 8px 5px 0}.mobile .nwtbVanCab{left:40px;top:13px;width:15px;height:19px;border-width:2px;border-left:0;border-radius:0 6px 4px 0}
 .nwtbVanWindow{position:absolute;left:4px;top:4px;width:11px;height:8px;background:#bfdbfe;border:1.5px solid #17202a;border-radius:2px}.mobile .nwtbVanWindow{left:3px;top:3px;width:8px;height:6px;border-width:1px}
 .nwtbWheel{position:absolute;width:12px;height:12px;border-radius:50%;background:#17202a;border:2px solid #fff;top:38px}.desktop .nwtbWheel{top:38px}.mobile .nwtbWheel{width:9px;height:9px;top:29px;border-width:1.5px}
 ...
 .nwtbLiveDot{position:absolute;right:-5px;top:-5px;width:10px;height:10px;border-radius:50%;background:#22c55e;border:2px solid #fff;box-shadow:0 0 0 0 rgba(34,197,94,.48);animation:nwtbLivePulse 1.7s infinite}
 .mobile .nwtbLiveDot{width:8px;height:8px;right:-4px;top:-4px}
...
function vanIcon(heading,near){
 style();const mobile=smallScreen(),cls=mobile?'mobile':'desktop',w=mobile?66:94,h=mobile?50:66,angle=Number.isFinite(Number(heading))?Number(heading):0;
...
function rowHeading(r){
 let h=Number(r?.heading_deg);const id=String(r?.driver_employee_number||''),now={lat:Number(r?.lat),lon:Number(r?.lon)};
