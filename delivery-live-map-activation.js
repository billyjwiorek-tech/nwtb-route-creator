...
const defs={tracker:{id:'fTracker',src:'tracker-live.html?v=20260924-1155'},driver:{id:'fDriver',src:'driver-live.html?v=20260924-1155'}};
function wake(name){
 ...
 const poke=()=>{try{f.contentWindow.dispatchEvent(new Event('resize'));const m=f.contentWindow.__nwtbNavMapInstance;if(m&&typeof m.invalidateSize==='function')m.invalidateSize({pan:true,animate:false,debounceMoveend:true})}catch{}};
